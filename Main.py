...
ruta = r"C:\Users\Atif Traders\3D Objects\Track-Padel-Match-main\Minimap\El punto más viral del Estrella Damm Santander Open 2021 _ World Padel Tour (1)_Trim.mp4"
...
im_src = cv2.imread(r"C:\Users\Atif Traders\3D Objects\Track-Padel-Match-main\Minimap\padelsito.png")
im_dst = cv2.imread(r"C:\Users\Atif Traders\3D Objects\Track-Padel-Match-main\Minimap\planta2.png")
...
while True: 
    ...
    minimapa.im_dst = cv2.imread(r"C:\Users\Atif Traders\3D Objects\Track-Padel-Match-main\Minimap\planta2.png")
